# Grapic-degin first code to make squre

#include <GL/freeglut.h> // Header for FreeGLUT
void display()
{
...
glVertex2f(.0f, 0.0f); // Point at center
glEnd();
glFlush(); // Render the point
}
void init()
{
glClearColor(0.5, 0.5, 1.0, 0.0); // White background
...
glutCreateWindow("Display a Point"); // Create window
